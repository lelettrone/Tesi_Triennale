...
# Title: Mio Ricevitore
# Author: Giacinto Gelli
...
class MIO_RICEVITORE(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Mio Ricevitore")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Mio Ricevitore")
        ...
        self.settings = Qt.QSettings("GNU Radio", "MIO_RICEVITORE")
        ...
        self.fm_stereo_demux_1 = fm_stereo_demux(
            audio_gain=1/0.45,
            audio_rate=48e3,
            tau=50e-6,
        )
        ...
        self._BB_gain_range = Range(0, 1, 0.1, 0.3, 200)
        ...
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.fm_stereo_demux_1, 1))
        ...
        self.connect((self.fm_stereo_demux_1, 0), (self.audio_sink_0, 0))
        self.connect((self.fm_stereo_demux_1, 1), (self.audio_sink_0, 1))
        self.connect((self.fm_stereo_demux_1, 0), (self.qtgui_freq_sink_x_0_0, 0))
        self.connect((self.fm_stereo_demux_1, 1), (self.qtgui_freq_sink_x_0_0, 1))
        self.connect((self.fm_stereo_demux_1, 0), (self.qtgui_time_sink_x_0_0, 0))
        self.connect((self.fm_stereo_demux_1, 1), (self.qtgui_time_sink_x_0_0, 1))
        self.connect((self.fx_demod_0, 1), (self.blocks_multiply_const_vxx_0, 0))
        self.connect((self.fx_demod_0, 2), (self.blocks_null_sink_1, 0))
        self.connect((self.fx_demod_0, 0), (self.fm_stereo_demux_1, 0))
        self.connect((self.fx_demod_0, 3), (self.qtgui_waterfall_sink_x_0, 0))
...
def main(top_block_cls=MIO_RICEVITORE, options=None):
