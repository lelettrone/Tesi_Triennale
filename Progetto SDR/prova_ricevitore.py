...
class prova_ricevitore(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Prova Ricevitore")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Prova Ricevitore")
        ...
        self.settings = Qt.QSettings("GNU Radio", "prova_ricevitore")
    ...
    def set_BB_gain(self, BB_gain):
        ...
        self.FM_stereo_demux_0.set_audio_gain(self.BB_gain)


def main(top_block_cls=prova_ricevitore, options=None):
